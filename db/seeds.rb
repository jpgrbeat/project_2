...
fluffy = Animal.create(name: 'Fluffy', age: 3, type_of_animal_id: cat.id, description: "Fluffy is a old and lazy cat. Perfect for people who don't want to interact with their pets.", shelter_id: shelter1.id)
killer = Animal.create(name: 'Killer', age: 4, type_of_animal_id: dog.id, description: "Killer is a mean killing machine. Perfect for former cops.", shelter_id: shelter1.id)
bubbles = Animal.create(name: 'Bubbles', age: 5, type_of_animal_id:  fish.id, description: "Bubbles loves to float around the tank doing nothing.", shelter_id: shelter1.id)
